export const dict = {
  ...
  "help.tabs.introduction": "Koma Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Koma ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Koma",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Koma",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Koma sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Koma segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Koma.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Koma",
  ...
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Koma.",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Koma",
  "desktop.recovery.terminated": "La finestra di Koma si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Koma non risponde",
