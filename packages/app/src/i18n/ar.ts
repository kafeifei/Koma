export const dict = {
  ...
  "desktop.menu.ariaLabel": "قائمة Koma",
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Koma",
  "desktop.recovery.terminated": "توقفت نافذة Koma بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Koma لا يستجيب",
  ...
  "help.tabs.introduction": "أصبح Koma Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Koma ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Koma",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Koma",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Koma على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Koma يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Koma.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Koma",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Koma.",
