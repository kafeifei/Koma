export const dict = {
  ...
  "desktop.menu.ariaLabel": "منوی Koma",
  ...
  "desktop.recovery.loadFailed": "Koma بارگیری نشد",
  "desktop.recovery.terminated": "پنجره Koma به طور غیرمنتظره ای خاتمه یافت",
  "desktop.recovery.unresponsive": "Koma پاسخ نمی دهد",
  ...
  "help.tabs.introduction": "Koma Desktop اکنون در اطراف زبانه ها ساخته شده است.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "نسخه جدیدی از Koma ({{version}}) اکنون برای نصب در دسترس است.",
  ...
  "error.page.report.prefix": "لطفاً این خطا را به تیم Koma گزارش دهید",
  ...
  "settings.general.row.language.description": "زبان نمایش را برای Koma تغییر دهید",
  ...
  "settings.general.row.appearance.description": "نحوه ظاهر Koma را در دستگاه خود سفارشی کنید",
  "settings.general.row.colorScheme.title": "طرح رنگ",
  "settings.general.row.colorScheme.description": "انتخاب کنید که آیا Koma از تم سیستمی، روشن یا تیره پیروی می کند",
  "settings.general.row.theme.title": "موضوع",
  "settings.general.row.theme.description": "نحوه مضمون سازی Koma را سفارشی کنید.",
  ...
  "settings.updates.row.startup.description": "هنگام راه‌اندازی Koma، به‌روزرسانی‌ها را به‌طور خودکار بررسی کنید",
  ...
  "settings.updates.toast.latest.description": "شما آخرین نسخه Koma را اجرا می کنید.",
