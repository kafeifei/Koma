export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma valmynd",
  ...
  "desktop.recovery.loadFailed": "Koma miseydnaðist at heinta",
  "desktop.recovery.terminated": "Koma vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Koma svarar ikki",
  ...
  "help.tabs.introduction": "Koma Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Koma ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Koma toymið",
  ...
  "app.name.desktop": "Koma Skrivaraborð",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Koma",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Koma sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Koma fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Koma er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Koma byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Koma.",
