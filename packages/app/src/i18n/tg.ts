export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma меню",
  ...
  "desktop.recovery.loadFailed": "Koma бор карда натавонист",
  "desktop.recovery.terminated": "Koma тиреза ба таври ғайричашмдошт қатъ карда шуд",
  "desktop.recovery.unresponsive": "Koma ҷавоб намедиҳад",
  ...
  "help.tabs.introduction": "Koma Desktop ҳоло дар атрофи ҷадвалҳо сохта шудааст.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Версияи нави Koma ({{version}}) ҳоло барои насб дастрас аст.",
  ...
  "error.page.report.prefix": "Лутфан дар бораи ин хато ба дастаи Koma хабар диҳед",
  ...
  "settings.general.row.language.description": "Забони намоишро барои Koma иваз кунед",
  ...
  "settings.general.row.appearance.description": "Фармоиш диҳед, ки чӣ гуна Koma дар дастгоҳи шумо намуди зоҳирӣ дорад",
  "settings.general.row.colorScheme.title": "Схемаи ранг",
  "settings.general.row.colorScheme.description":
    "Интихоб кунед, ки Koma аз рӯи система, равшанӣ ё мавзӯи торик пайравӣ мекунад",
  "settings.general.row.theme.title": "Мавзӯъ",
  "settings.general.row.theme.description": "Чӣ тавр Koma мавзӯъро танзим кунед.",
  ...
  "settings.updates.row.startup.description": "Ҳангоми оғоз кардани Koma навсозиҳо ба таври худкор санҷед",
  ...
  "settings.updates.toast.latest.description": "Шумо версияи охирини Koma-ро иҷро карда истодаед.",
