export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma menyusi",
  ...
  "desktop.recovery.loadFailed": "Koma yuklanmadi",
  "desktop.recovery.terminated": "Koma oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Koma javob bermayapti",
  ...
  "help.tabs.introduction": "Koma Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koma ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Koma jamoasiga xabar bering",
  ...
  "settings.general.row.language.description": "Koma uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Koma qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Koma tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Koma mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Koma ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Koma oxirgi versiyasini ishga tushiryapsiz.",
