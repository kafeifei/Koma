export const dict = {
  ...
  "desktop.menu.ariaLabel": "Meniu Koma",
  ...
  "desktop.recovery.loadFailed": "Koma nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Koma s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Koma nu răspunde",
  ...
  "help.tabs.introduction": "Koma Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Koma ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Koma",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Koma",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Koma pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Koma urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Koma.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Koma",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Koma.",
