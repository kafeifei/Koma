export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma menüü",
  ...
  "desktop.recovery.loadFailed": "Koma laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Koma aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Koma ei vasta",
  ...
  "help.tabs.introduction": "Koma Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Koma ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Koma meeskonnale",
  ...
  "settings.general.row.language.description": "Muutke Koma kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Koma teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Koma järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Koma on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Koma käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Koma uusimat versiooni.",
