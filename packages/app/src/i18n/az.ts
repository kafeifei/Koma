export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma menyusu",
  ...
  "desktop.recovery.loadFailed": "Koma yüklənə bilmədi",
  "desktop.recovery.terminated": "Koma pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Koma cavab vermir",
  ...
  "help.tabs.introduction": "Koma Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koma-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Koma komandasına",
  ...
  "settings.general.row.language.description": "Koma üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Koma-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description": "Koma-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Koma-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Koma açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Koma-un ən son versiyasından istifadə edirsiniz.",
