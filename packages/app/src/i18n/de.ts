...
export const dict = {
  ...
  "toast.update.description": "Eine neue Version von Koma ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Koma-Team",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Koma ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Koma auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Koma dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Koma anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Koma automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Die aktuelle Version von Koma wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "Koma-Menü",
  ...
  "desktop.recovery.loadFailed": "Koma konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Koma-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Koma reagiert nicht",
  ...
  "help.tabs.introduction": "Koma Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
