export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koma ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Koma se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Koma se ne odziva",
  ...
  "help.tabs.introduction": "Koma Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Koma ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Koma",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Koma",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Koma izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Koma sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Koma.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Koma",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Koma.",
