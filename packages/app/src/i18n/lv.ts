export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Koma",
  "desktop.recovery.terminated": "Koma logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Koma neatbild",
  ...
  "help.tabs.introduction": "Koma Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Koma versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Koma komandai",
  ...
  "app.name.desktop": "Koma darbvirsma",
  ...
  "settings.general.row.language.description": "Mainīt Koma saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Koma izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description": "Izvēlieties, vai Koma sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Koma tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Koma",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Koma versiju.",
