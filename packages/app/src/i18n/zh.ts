...
export const dict = {
  ...
  "settings.remote.account.description": "登录后查看和连接你的设备。",
  ...
  "settings.remote.local.enable.title": "允许远程访问",
  "settings.remote.local.enable.description": "使用同一 GitHub 帐户访问这台电脑。",
