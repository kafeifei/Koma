...
export const dict = {
  ...
  "settings.computerUse.install": "安装 Cua Driver",
  "settings.computerUse.start": "启动驱动",
  "settings.computerUse.refresh": "刷新状态",
  "settings.computerUse.permissionsTitle": "系统权限",
  ...
  "settings.computerUse.grantDescription": "请在上述设备的系统设置中为 CuaDriver 授权。现有应用和任务不会自动重启。",
  "settings.computerUse.grant": "设置权限",
