...
export const dict = {
  "settings.extensions.wakatimeSetup": "需要按项目说明配置 WakaTime API Key。",
  "settings.extensions.dcpSetup": "后端功能作用于 OpenCode；其 TUI 界面不会显示在 Koma 中。",
  "settings.extensions.view": "资源视图",
  "settings.extensions.discover": "发现",
  "settings.extensions.officialDirectory": "官方文档资源目录",
  "settings.extensions.directoryScope": "OpenCode 官方文档收录的社区资源。安装方式与 Koma 兼容性分别核实。",
  "settings.extensions.refreshing": "正在刷新…",
  "settings.extensions.refreshDirectory": "刷新目录",
  "settings.extensions.catalogOrigin.bundled": "内置目录",
  "settings.extensions.catalogOrigin.cache": "缓存目录",
  "settings.extensions.catalogOrigin.remote": "已从官方文档更新",
  "settings.extensions.directoryUnavailable": "目录暂时无法更新，已有资源仍可浏览。",
  "settings.extensions.searchResources": "搜索名称、功能或包名",
  "settings.extensions.filterResources": "筛选资源",
  "settings.extensions.allResources": "全部资源",
  "settings.extensions.readyResources": "可直接安装或配置",
  "settings.extensions.instructions": "规则",
  "settings.extensions.importInstructions": "导入规则",
  "settings.extensions.sourceInstall": "安装固定版本源码与依赖，校验文件完整性",
  "settings.extensions.builtin": "已内置",
  "settings.extensions.kind.plugin": "OpenCode 插件",
  "settings.extensions.kind.mcp": "MCP 服务",
  "settings.extensions.kind.project": "外部项目",
  "settings.extensions.kind.agent": "Agent 配置",
  "settings.extensions.noResources": "没有匹配的资源。",
  "settings.extensions.recipeVerified": "安装方式已核实；运行兼容性以实际加载结果为准",
  "settings.extensions.requiresAuthorization": "连接后需要账号授权。",
  "settings.extensions.mcpTemplate": "使用官方 MCP 示例中的连接配置。",
  "settings.extensions.manualRecipe": "请按项目说明接入，尚未核实直接安装方式。",
  "settings.extensions.externalResource": "通过项目页面获取资源，并按其说明接入。",
  "settings.extensions.sourceDocs": "收录来源",
  "settings.extensions.projectDocs": "项目与使用说明",
  "settings.extensions.configureIntegration": "配置接入",
  "settings.extensions.connectionType": "连接方式",
  "settings.extensions.remote": "远程地址",
  "settings.extensions.local": "本地命令",
  "settings.extensions.endpoint": "MCP 服务地址",
  "settings.extensions.command": "执行程序",
  "settings.extensions.arguments": "参数（每行一个）",
  "settings.extensions.advanced": "高级选项",
  "settings.extensions.section": "扩展",
  "settings.extensions.plugins": "插件",
  "settings.extensions.integrations": "集成",
  "settings.extensions.addPlugin": "添加插件",
  "settings.extensions.addIntegration": "添加 MCP",
  "settings.extensions.pluginScope": "作用于当前服务的 OpenCode 任务。原生 Codex 任务使用独立运行时。",
  "settings.extensions.trust": "插件继承后端的文件、网络和命令执行权限。请安装你信任的来源。",
  "settings.extensions.pending": "待重新加载",
  "settings.extensions.failed": "加载失败",
  "settings.extensions.active": "运行中",
  "settings.extensions.disabled": "已停用",
  "settings.extensions.ready": "已安装",
  "settings.extensions.loading": "正在加载…",
  "settings.extensions.working": "正在处理…",
  "settings.extensions.package": "npm 包名或本地路径",
  "settings.extensions.options": "插件选项（JSON）",
  "settings.extensions.cancel": "取消",
  "settings.extensions.save": "保存",
  "settings.extensions.installed": "已安装",
  "settings.extensions.refresh": "刷新",
  "settings.extensions.emptyPlugins": "还没有安装插件。",
  "settings.extensions.external": "由现有配置文件管理",
  "settings.extensions.reloadNote":
    "配置已保存，已加载的实例将在后端重新启动后生效。卸载保留共享包缓存和插件自行创建的数据。",
  "settings.extensions.enable": "启用",
  "settings.extensions.configure": "配置",
  "settings.extensions.uninstall": "卸载",
  "settings.extensions.available": "可添加的插件",
  "settings.extensions.formatter": "整理 OpenCode 回复中的 Markdown 表格。由 franlol 维护的社区插件。",
  "settings.extensions.install": "安装",
  "settings.extensions.integrationScope": "为当前服务的此项目配置 OpenCode MCP 连接：",
  "settings.extensions.selectProject": "请先打开一个项目，再管理它的集成。",
  "settings.extensions.name": "名称",
  "settings.extensions.mcpConfig": "MCP 配置（JSON）",
  "settings.extensions.mcpHelp":
    "远程连接填写 type、url，可选 headers 或 oauth；本地连接填写 type、command 数组，可选 environment。本地命令在所连接的服务端执行。",
  "settings.extensions.emptyIntegrations": "这个项目还没有 MCP 集成。",
  "settings.extensions.authorize": "授权",
  "settings.extensions.remove": "移除",
  "settings.extensions.status.connected": "已连接",
  "settings.extensions.status.disabled": "未连接",
  "settings.extensions.status.failed": "连接失败",
  "settings.extensions.status.needs_auth": "需要授权",
  "settings.extensions.status.needs_client_registration": "需要配置 OAuth 客户端",
  ...
  "session.panel.tool": "工具详情",
  "session.panel.child": "子任务预览",
  "session.panel.terminalClosed": "此终端已关闭。",
  "session.panel.existingTerminals": "已有终端",
  "session.inspector.background.empty": "暂无工具或子代理活动",
  "session.inspector.tools": "工具",
  "session.inspector.subagents": "子代理",
  "session.inspector.tool": "工具",
  "session.inspector.subagent": "子代理",
  "session.inspector.status.pending": "等待中",
  "session.inspector.status.running": "运行中",
  "session.inspector.status.completed": "已完成",
  "session.inspector.status.error": "失败",
  "session.inspector.status.idle": "空闲",
  "session.inspector.status.retry": "正在重试",
  "session.inspector.status.archived": "已归档",
  "session.inspector.status.unknown": "未知",
  "session.inspector.loadEarlier": "加载更早的活动",
  "session.inspector.loadingEarlier": "正在加载更早的活动",
  "session.inspector.openFullTask": "打开完整任务",
  "session.inspector.output": "输出",
  "session.inspector.input": "输入",
  "session.inspector.error": "错误",
  "session.inspector.missingTool": "工具详情不可用",
  "session.inspector.missingSession": "此任务不可用",
  "session.inspector.child.empty": "暂无消息",
  "session.inspector.loadFailed": "无法加载活动",
  "session.inspector.retry": "重试",
  ...
  "prompt.toast.engineUnavailable.title": "无法确定会话引擎",
  "prompt.toast.codexUnsupported.title": "Codex 不支持此输入",
  "prompt.toast.codexUnsupported.description": "Codex 会话不支持 shell 模式、OpenCode 命令或 @智能体 提及。",
  "prompt.toast.codexUnavailable.title": "Codex 无法接收输入",
  "prompt.toast.codexUnavailable.description": "原生会话不可用或不接受提示。",

  "codex.task.takeover": "停止并接管",
  "codex.engine.label": "执行引擎",
  "codex.controls.title": "Codex 控制",
  "codex.runtime.resolving": "正在解析",
  "codex.runtime.creating": "正在创建",
  "codex.runtime.idle": "就绪",
  "codex.runtime.active": "运行中",
  "codex.runtime.waitingApproval": "等待批准",
  "codex.runtime.waitingInput": "等待输入",
  "codex.runtime.interrupting": "正在停止",
  "codex.runtime.disconnected": "已断开连接",
  "codex.runtime.systemError": "系统错误",
  "codex.runtime.bindingUnavailable": "原生会话不可用",
  "codex.account.signIn": "登录 Codex",
  "codex.account.cancelSignIn": "取消登录",
  "codex.account.pending": "等待登录",
  "codex.account.signedIn": "已登录 Codex",
  "codex.account.unavailable": "Codex 不可用",
  "codex.pendingSettings.title": "待应用的设置",
  "codex.pendingSettings.hint":
    "已应用的设置：{{model}} · {{effort}} · {{permission}}。新发送的输入使用所选设置，已提交的输入保留原设置；当前审批仍需处理。",
  "codex.settings.selectProviderModel": "重新选择 Provider 模型",
  "codex.settings.model": "模型",
  "codex.settings.effort": "推理强度",
  "codex.settings.permission": "权限",
  "codex.settings.updateFailed": "无法更新 Codex 设置",
  "codex.settings.nativeDefault": "原生默认设置",
  "codex.permission.workspace": "工作区访问权限",
  "codex.permission.nativeDefault": "原生默认设置",
  "codex.permission.readOnly": "只读",
  "codex.permission.full": "完全访问权限",
  "codex.plan.title": "最近报告的计划",
  "codex.plan.loading": "正在加载计划...",
  "codex.plan.pending": "待处理",
  "codex.plan.inProgress": "进行中",
  "codex.plan.completed": "已完成",
  "codex.queue.title": "队列",
  "codex.queue.paused": "已暂停",
  "codex.queue.resume": "继续",
  "codex.queue.pause": "暂停",
  "codex.queue.withdraw": "撤回",
  "codex.delivery.queue": "排队输入",
  "codex.delivery.steer": "即时输入",
  "codex.delivery.pending": "待发送",
  "codex.delivery.returned": "未进入会话",
  "codex.delivery.returnedHint": "该轮已结束，这条输入未进入会话。继续后可以重新发送。",
  "codex.delivery.pausedHint": "这条输入已暂停，继续后才会发送。",
  "codex.delivery.waitEarlier": "正在等待前一条输入。",
  "codex.delivery.waitIdle": "正在等待当前轮次结束。",
  "codex.delivery.waitSettings": "正在等待下一轮应用所选设置。",
  "codex.delivery.sending": "正在发送",
  "codex.delivery.accepted": "已接收",
  "codex.delivery.unknown": "状态未知",
  "codex.delivery.rejected": "已拒绝",
  ...
  "codex.interaction.choice.allowSession": "在此任务中允许",
  "codex.interaction.choice.deny": "拒绝",
  "codex.interaction.choice.cancel": "取消",
  "codex.interaction.choice.custom": "使用自定义回复",
  "codex.interaction.choice.allowCommandRule": "允许并记住这条命令规则",
  "codex.interaction.choice.commandRuleHint": "以后不再询问以下开头的命令：{{prefix}}",
  "codex.interaction.choice.allowNetworkRule": "始终允许访问 {{host}}",
  "codex.interaction.choice.denyNetworkRule": "禁止访问 {{host}}",
  "codex.question.other": "其他回复",
  "codex.question.placeholder": "输入回复",
  "codex.form.invalid": "Codex 请求的表单无法在此版本中显示。",
  "codex.url.open": "打开链接",
  "codex.context.currentTokens": "当前上下文令牌数",
  "codex.context.totalTokens": "累计令牌数",
  "codex.diff.unavailable": "Codex 未提供这一轮的变更记录。",
  ...
  "help.tabs.introduction": "Koma Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "context.usage.contextWindow": "上下文窗口",
  "context.usage.used": "已用",
  "context.usage.tokenRange": "{{used}} / {{limit}} token",
  "context.usage.sessionCost": "会话费用（估算）",
  "context.usage.limit": "使用额度",
  "context.usage.resets": "{{time}} 重置",
  "context.usage.credits": "剩余额度",
  "context.usage.unlimited": "无限",
  ...
  "toast.update.description": "Koma 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Koma 团队",
  ...
  "session.new.worktree.baseBranch": "基础分支",
  "session.new.worktree.optionsFailed": "无法加载 Worktree 选项",
  "session.new.worktree.useLocal": "使用本地目录",
  "prompt.toast.worktreeNotReady.title": "请先确认任务工作目录，再发送消息",
  ...
  "settings.computerUse.description": "让 Agent 查看并操作任务所在设备上的应用。",
  "settings.computerUse.enable": "启用电脑控制",
  "settings.computerUse.scope": "适用于此设备上的 OpenCode 和 Codex。更改从下一轮生效，已经执行中的操作可能继续完成。",
  "settings.computerUse.device": "控制设备",
  "settings.computerUse.loading": "正在检查…",
  "settings.computerUse.unsupported": "目前支持在 macOS 上配置",
  "settings.computerUse.busy": "正在配置…",
  "settings.computerUse.error": "需要处理",
  "settings.computerUse.notInstalled": "未安装",
  "settings.computerUse.notRunning": "驱动未运行",
  "settings.computerUse.permissions": "待授权",
  "settings.computerUse.ready": "驱动已就绪",
  "settings.computerUse.disabled": "已关闭",
  "settings.computerUse.installTitle": "1. 安装并启动 CuaDriver",
  "settings.computerUse.installDescription":
    "CuaDriver 负责查看屏幕和操作应用。安装完成后会自动启动，再继续下面的授权。",
  "settings.computerUse.install": "安装并启动 CuaDriver",
  "settings.computerUse.installing": "正在安装并启动…",
  "settings.computerUse.starting": "正在启动…",
  "settings.computerUse.running": "已运行",
  "settings.computerUse.start": "启动驱动",
  ...
  "settings.computerUse.readyToEnable": "两项权限已授权，可以启用。",
  "settings.computerUse.finishSetup": "完成安装和两项授权后，即可启用。",
  "settings.section.desktop": "桌面",
  "settings.section.server": "服务器",

  "settings.connections.copy": "复制",
  "settings.remote.rename": "重命名",
  "settings.tab.connections": "连接",
  "settings.remote.cleanup.expiration": "本页提供手动清理。服务商默认在连续 30 天无活动后回收隧道。",
  "settings.remote.cleanup.note": "离线记录仍占名额。清理只删除隧道登记，设备上的项目与任务保留。",
  "settings.remote.cleanup.refreshRequired": "暂时无法获取设备状态，请刷新后再清理。",
  "settings.remote.cleanup.empty": "没有可清理的离线记录。",
  "settings.remote.cleanup.failed": "删除失败，请刷新后重试",
  "settings.remote.cleanup.protected": "此记录受保护，已保留",
  "settings.remote.cleanup.unknown": "无法确认离线状态，已保留",
  "settings.remote.cleanup.online": "设备已上线，已保留",
  "settings.remote.cleanup.result": "已清理 {{count}} 条记录。",
  "settings.remote.cleanup.removing": "正在删除…",
  "settings.remote.cleanup.remove": "删除 {{count}} 条记录",
  "settings.remote.cleanup.consequence":
    "删除后原隧道入口失效，设备上的项目与任务保留。再次开启远程访问时可以重新登记。",
  "settings.remote.cleanup.scope": "只列出已确认离线的其他设备。本机、已接入设备和状态未知的记录不会被清理。",
  "settings.remote.cleanup.selectAll": "全选 / 取消全选",
  "settings.remote.cleanup.candidates": "{{count}} 条可清理记录",
  "settings.remote.cleanup.description": "选择不再使用的 Koma 隧道。离线设备也可能只是休眠或暂时关机。",
  "settings.remote.cleanup.device": "删除 {{name}} 的隧道",
  "settings.remote.cleanup.title": "清理离线记录",
  "settings.remote.quota.full": "隧道名额已满。清理不再使用的离线记录后，可继续添加设备。",
  "settings.remote.quota.koma": "Koma 登记 {{count}} 条",
  "settings.remote.quota.title": "账号隧道名额（含其他应用）",
  "settings.remote.devices.incomplete": "登记不完整 · 暂不可连接",
  "settings.remote.website.description": "在其他设备的浏览器登录，选择要访问的在线设备。",
  "settings.remote.account.signOut.description":
    "退出登录会关闭本机隧道，并断开通过此账号建立的设备连接。保存的服务地址、本地 Web 入口和云端登记会保留。",
  "settings.remote.local.disable.description":
    "其他设备将无法通过此隧道访问本机。本机任务、已连接的其他设备及隧道登记会保留。",
  "settings.remote.local.disable": "关闭本机远程隧道",
  "settings.connections.native.note": "任务在所属服务上运行，打开其他服务的项目不会停止已有任务。",
  "settings.connections.web": "本地 Web 入口",
  "settings.connections.openProjects": "打开项目",
  "settings.connections.saved.description": "添加本机、局域网或公网地址，可同时接入多个服务。",
  "settings.connections.builtin": "应用内置",
  "settings.connections.localDevice": "本机",
  "settings.connections.local": "本机服务",
  "settings.connections.tunnel": "远程隧道",
  "settings.connections.native": "原生服务",
  "settings.connections.description": "管理服务地址，以及通过远程隧道访问设备的方式。",
  "settings.connections.saved": "服务地址",
  "settings.connections.devices": "账号中的设备",
  "settings.tab.general": "通用",
  "settings.tab.shortcuts": "快捷键",
  "settings.tab.remote": "远程",
  "settings.remote.title": "远程",
  "settings.remote.description": "从其他设备继续工作，也可以连接你的其他电脑。",
  "settings.remote.loading": "正在加载远程访问…",
  "settings.remote.refresh": "刷新",
  "settings.remote.account.title": "GitHub 帐户",
  "settings.remote.account.description": "登录以发现其他电脑，也可开启本机远程访问。",
  "settings.remote.account.signedIn": "已登录 GitHub 帐户",
  "settings.remote.account.signIn": "登录",
  "settings.remote.account.signingIn": "等待登录…",
  "settings.remote.account.signOut": "退出登录",
  "settings.remote.account.signingOut": "正在退出…",
  "settings.remote.authorization.title": "在 GitHub 上完成登录",
  "settings.remote.authorization.description": "复制这个一次性代码，然后打开 GitHub 授权访问。",
  "settings.remote.authorization.code": "一次性代码",
  "settings.remote.authorization.copy": "复制代码",
  "settings.remote.authorization.open": "打开 GitHub",
  "settings.remote.authorization.cancel": "取消登录",
  "settings.remote.authorization.waiting": "正在等待 GitHub 授权…",
  "settings.remote.authorization.attribution":
    "GitHub 授权页可能显示“Visual Studio Code”，这是此实验功能使用的登录客户端。",
  "settings.remote.local.section": "这台电脑",
  "settings.remote.local.enable.title": "允许通过远程隧道访问本机",
  "settings.remote.local.enable.description": "使用同一 GitHub 账号访问本机，与连接其他设备相互独立。",
  "settings.remote.local.enable.signedOut": "开启时将引导你登录 GitHub 帐户。",
  "settings.remote.local.deviceName": "设备名称",
  "settings.remote.local.deviceName.description": "显示在设备列表中。隧道开启时，保存名称会短暂重建本机隧道连接。",
  "settings.remote.local.status": "连接状态",
  "settings.remote.local.website": "远程 Web 入口",
  ...
  "settings.remote.status.online": "已就绪，可远程访问",
  "settings.remote.status.offline": "离线",
  "settings.remote.devices.section": "其他设备",
  "settings.remote.devices.signedOut": "登录后，这里会显示已开启远程访问的其他设备。",
  "settings.remote.devices.empty": "没有可用的其他设备。",
  "settings.remote.devices.online": "在线",
  "settings.remote.devices.offline": "离线",
  "settings.remote.devices.unknown": "状态不可用",
  "settings.remote.devices.connect": "连接",
  "settings.remote.devices.connecting": "正在连接…",
  "settings.remote.unavailable.title": "远程访问不可用",
  "settings.remote.unavailable.description": "此版本尚未配置 Microsoft 远程访问。",
  "settings.remote.error.action": "无法完成远程访问操作，请重试。",
  "settings.remote.error.configuration": "此版本的远程访问配置不正确。",
  "settings.remote.error.authentication": "GitHub 登录状态需要处理，请重新登录。",
  "settings.remote.error.connection": "远程访问暂时无法连接。",
  "settings.remote.service": "连接服务由 Microsoft Dev Tunnels 提供",
  ...
  "settings.general.row.language.description": "更改 Koma 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Koma 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Koma 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Koma 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Koma 启动时自动检查更新",
  ...
  "worktree.manager.description": "查看关联目录、任务归属和回收状态。",
  "worktree.manager.refresh": "刷新",
  "worktree.manager.loading": "正在加载 Worktree…",
  "worktree.manager.loadFailed": "无法加载 Worktree。",
  "worktree.manager.retry": "重试",
  "worktree.manager.empty": "未找到关联的 Worktree。",
  "worktree.manager.status.primary": "主目录",
  "worktree.manager.status.managed": "已管理",
  "worktree.manager.status.unbound": "未绑定任务",
  "worktree.manager.status.shared": "共享目录",
  "worktree.manager.status.missing": "目录缺失",
  "worktree.manager.status.inUse": "使用中",
  "worktree.manager.status.idle": "空闲",
  "worktree.manager.branch.detached": "分离的 HEAD",
  "worktree.manager.sessions": "关联任务",
  "worktree.manager.noSessions": "没有关联任务",
  "worktree.manager.archived": "已归档",
  "worktree.manager.directoryStatus": "目录状态",
  "worktree.manager.ownerFailure": "上次生命周期操作失败",
  "worktree.manager.space": "空间占用",
  "worktree.manager.spacePending": "正在计算…",
  "worktree.manager.open": "打开目录",
  "worktree.manager.adopt": "接管",
  "worktree.manager.cleanup": "清理未绑定 Worktree",
  "worktree.manager.confirmAdoptTitle": "接管这个 Worktree？",
  "worktree.manager.confirmAdopt": "Koma 将接管这个已关联的 Worktree；分支和文件会留在原处。",
  "worktree.manager.confirmCleanupTitle": "删除这个未绑定的 Worktree？",
  "worktree.manager.confirmCleanup": "这会删除 {{directory}} 以及其中全部本地文件（包括忽略文件），但不会删除任务。",
  "worktree.manager.confirm": "确认",
  "worktree.manager.cancel": "取消",
  "worktree.manager.operationFailed": "操作失败；无需关闭弹窗即可重试。",
  "worktree.manager.ignored.title": "归档文件保留",
  "worktree.manager.ignored.description": "受管归档会保留普通本地文件，并跳过可重建依赖和缓存。",
  "worktree.manager.ignored.preserved": "保留",
  "worktree.manager.ignored.skipped": "跳过",
  "worktree.manager.ignored.unsupported": "不支持",
  "worktree.manager.ignored.none": "无",
  "worktree.manager.usageBoundary":
    "后端按终端启动目录记录占用；外部进程、终端随后切换目录以及脱离后端的子进程不在检测范围内。",
  "worktree.merge.preview": "预览合回",
  "worktree.merge.title": "合回到主目录",
  "worktree.merge.description": "先检查结果，再将其放入主目录暂存区。主目录必须保持干净且未发生变化。",
  "worktree.merge.target": "目标目录",
  "worktree.merge.files": "变更文件",
  "worktree.merge.conflicts": "冲突文件",
  "worktree.merge.noChanges": "没有可应用的文件变更。",
  "worktree.merge.truncated": "差异预览已截断。",
  "worktree.merge.conflictHelp": "请打开来源目录解决冲突，然后重新预览。",
  "worktree.merge.apply": "应用到主目录暂存区",
  "worktree.merge.applied": "变更已放入主目录暂存区，可检查后提交。",
  "worktree.merge.previewFailed": "无法预览合回。",
  "worktree.merge.applyFailed": "无法应用已检查的合回结果；请重新预览后再试。",
  "worktree.merge.retry": "重新预览",
  "worktree.merge.close": "关闭预览",
  "worktree.manager.lifecycle.archive": "正在归档",
  "worktree.manager.lifecycle.restore": "正在恢复",
  "worktree.manager.lifecycle.delete": "正在删除",
  "worktree.manager.lifecycle.reclaimed": "已回收",
  "worktree.manager.lifecycle.preserved": "已保留本地文件",
  "worktree.merge.conflictChoice": "每项会采用所选侧的整份文件。请逐个选择，再重新预览结果。",
  "worktree.merge.keepTarget": "保留主目录版本",
  "worktree.merge.useSource": "采用 Worktree 版本",
  "worktree.merge.previewSelections": "重新预览所选结果",
  "worktree.merge.unresolved": "请先为每个冲突选择版本，再重新预览。",
  "worktree.merge.directoriesUnchanged": "预览、修改选择或取消都不会改变任一目录。",
  "worktree.merge.selectionChanged": "选择已改变。应用前请重新预览所选结果。",
