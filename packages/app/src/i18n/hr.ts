...
export const dict = {
  ...
  "help.tabs.introduction": "Radna površina Koma sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Koma ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Koma timu",
  ...
  "app.name.desktop": "Koma Radna površina",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Koma",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Koma izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description": "Odaberite hoće li Koma slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Koma tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Koma pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Koma.",
