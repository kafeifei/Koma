export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koma لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Koma دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Koma جواب نئیں دے رہیا",
  ...
  "help.tabs.introduction": "Koma Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koma ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Koma ٹیم نوں دیو",
  ...
  "settings.general.row.language.description": "Koma لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Koma کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Koma سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Koma نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Koma لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Koma دا تازہ ترین ورژن چلا رئے او۔",
