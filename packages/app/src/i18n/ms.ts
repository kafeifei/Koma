export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koma gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Koma ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Koma tidak memberi respons",
  ...
  "help.tabs.introduction": "Koma Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Koma ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Koma",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Koma",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Koma pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Koma mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Koma dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Koma.",
