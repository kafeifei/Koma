export const dict = {
  ...
  "desktop.recovery.loadFailed": "Không tải được Koma",
  "desktop.recovery.terminated": "Cửa sổ Koma đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Koma không phản hồi",
  ...
  "help.tabs.introduction": "Koma Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Koma ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Koma",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Koma",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Koma trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Koma tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Koma.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Koma khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Koma.",
