export const dict = {
  ...
  "toast.update.description": "Koman uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Koma-tiimille",
  ...
  "settings.general.row.language.description": "Vaihda Koman näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Koma näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Koma järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Koman teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Koma käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Koman uusinta versiota.",
  ...
  "desktop.menu.ariaLabel": "Koma-valikko",
  ...
  "desktop.recovery.loadFailed": "Koman lataaminen epäonnistui",
  "desktop.recovery.terminated": "Koma-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Koma ei vastaa",
  ...
  "help.tabs.introduction": "Koma Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
