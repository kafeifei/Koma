export const dict = {
  ...
  "desktop.menu.ariaLabel": "Komaምናሌ",
  ...
  "desktop.recovery.loadFailed": "Koma መጫን አልቻለም",
  "desktop.recovery.terminated": "Koma መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Koma ምላሽ እየሰጠ አይደለም",
  ...
  "help.tabs.introduction": "Koma ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የKoma ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለKoma ቡድን ያሳውቁ",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለKoma",
  ...
  "settings.general.row.appearance.description": "Komaበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Koma ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Koma ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Koma ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የKoma እትም እያሄዱ ነው።",
