export const dict = {
  ...
  "desktop.menu.ariaLabel": "menú Koma.",
  ...
  "desktop.recovery.loadFailed": "Koma no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Koma s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Koma no respon",
  ...
  "help.tabs.introduction": "Koma L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Koma ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Koma.",
  ...
  "app.name.desktop": "Koma Escriptori",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Koma",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Koma al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Koma segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Koma.",
  ...
  "settings.updates.row.startup.description": "Comprova automàticament si hi ha actualitzacions quan s'iniciï Koma.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Koma.",
