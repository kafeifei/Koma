...
export const dict = {
  ...
  "settings.computerUse.refresh": "Refresh status",
  "settings.computerUse.permissionsTitle": "System permissions",
  ...
  "settings.computerUse.grantDescription":
    "Grant these permissions to CuaDriver in System Settings on the device shown above. Existing apps and tasks are not restarted.",
  "settings.computerUse.grant": "Set up permissions",
