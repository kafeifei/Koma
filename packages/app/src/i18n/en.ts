...
export const dict = {
  "settings.extensions.wakatimeSetup":
    "Requires a WakaTime API key configured as described in the project instructions.",
  "settings.extensions.dcpSetup": "Its backend features run in OpenCode. The TUI interface is not displayed in Koma.",
  "settings.extensions.view": "Resource view",
  "settings.extensions.discover": "Discover",
  "settings.extensions.officialDirectory": "From the official documentation",
  "settings.extensions.directoryScope":
    "Community resources listed by OpenCode. Installation instructions and Koma compatibility are checked separately.",
  "settings.extensions.refreshing": "Refreshing…",
  "settings.extensions.refreshDirectory": "Refresh directory",
  "settings.extensions.catalogOrigin.bundled": "Bundled directory",
  "settings.extensions.catalogOrigin.cache": "Cached directory",
  "settings.extensions.catalogOrigin.remote": "Updated from official documentation",
  "settings.extensions.directoryUnavailable": "Could not update the directory. Existing resources remain available.",
  "settings.extensions.searchResources": "Search names, features or packages",
  "settings.extensions.filterResources": "Filter resources",
  "settings.extensions.allResources": "All resources",
  "settings.extensions.readyResources": "Install or configure here",
  "settings.extensions.instructions": "Instructions",
  "settings.extensions.importInstructions": "Import instructions",
  "settings.extensions.sourceInstall": "Pinned source and dependencies; verified file integrity",
  "settings.extensions.builtin": "Built in",
  "settings.extensions.kind.plugin": "OpenCode plugin",
  "settings.extensions.kind.mcp": "MCP service",
  "settings.extensions.kind.project": "External project",
  "settings.extensions.kind.agent": "Agent configuration",
  "settings.extensions.noResources": "No matching resources.",
  "settings.extensions.recipeVerified": "Install method checked; runtime compatibility is confirmed after loading",
  "settings.extensions.requiresAuthorization": "Connect, then authorize your account.",
  "settings.extensions.mcpTemplate": "Configuration from the official MCP example.",
  "settings.extensions.manualRecipe":
    "Follow the project instructions for setup; direct installation has not been verified.",
  "settings.extensions.externalResource": "Get this resource from its project page and follow the setup instructions.",
  "settings.extensions.sourceDocs": "Source documentation",
  "settings.extensions.projectDocs": "Project & setup",
  "settings.extensions.configureIntegration": "Configure connection",
  "settings.extensions.connectionType": "Connection type",
  "settings.extensions.remote": "Remote URL",
  "settings.extensions.local": "Local command",
  "settings.extensions.endpoint": "MCP server URL",
  "settings.extensions.command": "Executable",
  "settings.extensions.arguments": "Arguments (one per line)",
  "settings.extensions.advanced": "Advanced options",
  "settings.extensions.section": "Extensions",
  "settings.extensions.plugins": "Plugins",
  "settings.extensions.integrations": "Integrations",
  "settings.extensions.addPlugin": "Add plugin",
  "settings.extensions.addIntegration": "Add MCP",
  "settings.extensions.pluginScope":
    "Applies to OpenCode tasks on the selected server. Native Codex tasks use their own runtime.",
  "settings.extensions.trust":
    "Plugins run with the backend’s file, network and command access. Install only sources you trust.",
  "settings.extensions.pending": "Pending reload",
  "settings.extensions.failed": "Load failed",
  "settings.extensions.active": "Running",
  "settings.extensions.disabled": "Disabled",
  "settings.extensions.ready": "Installed",
  "settings.extensions.loading": "Loading…",
  "settings.extensions.working": "Working…",
  "settings.extensions.package": "npm package or local path",
  "settings.extensions.options": "Plugin options (JSON)",
  "settings.extensions.cancel": "Cancel",
  "settings.extensions.save": "Save",
  "settings.extensions.installed": "Installed",
  "settings.extensions.refresh": "Refresh",
  "settings.extensions.emptyPlugins": "No plugins installed yet.",
  "settings.extensions.external": "Managed by a configuration file",
  "settings.extensions.reloadNote":
    "Saved. Existing instances keep their loaded version until the backend is restarted. Uninstalling preserves shared package caches and plugin-created data.",
  "settings.extensions.enable": "Enable",
  "settings.extensions.configure": "Configure",
  "settings.extensions.uninstall": "Uninstall",
  "settings.extensions.available": "Available plugins",
  "settings.extensions.formatter": "Formats Markdown tables in OpenCode responses. Community plugin by franlol.",
  "settings.extensions.install": "Install",
  "settings.extensions.integrationScope": "OpenCode MCP connections for this project on the selected server:",
  "settings.extensions.selectProject": "Open a project to manage its integrations.",
  "settings.extensions.name": "Name",
  "settings.extensions.mcpConfig": "MCP configuration (JSON)",
  "settings.extensions.mcpHelp":
    "Remote: type, url, optional headers or oauth. Local: type, command array, optional environment. Local commands run on the connected server.",
  "settings.extensions.emptyIntegrations": "No MCP integrations for this project.",
  "settings.extensions.authorize": "Authorize",
  "settings.extensions.remove": "Remove",
  "settings.extensions.status.connected": "Connected",
  "settings.extensions.status.disabled": "Disconnected",
  "settings.extensions.status.failed": "Connection failed",
  "settings.extensions.status.needs_auth": "Authorization required",
  "settings.extensions.status.needs_client_registration": "Client registration required",
  ...
  "session.panel.tool": "Tool details",
  "session.panel.child": "Subagent preview",
  "session.panel.terminalClosed": "This terminal has closed.",
  "session.panel.existingTerminals": "Existing terminals",
  "session.inspector.background.empty": "No tool or subagent activity yet",
  "session.inspector.tools": "Tools",
  "session.inspector.subagents": "Subagents",
  "session.inspector.tool": "Tool",
  "session.inspector.subagent": "Subagent",
  "session.inspector.status.pending": "Pending",
  "session.inspector.status.running": "Running",
  "session.inspector.status.completed": "Completed",
  "session.inspector.status.error": "Failed",
  "session.inspector.status.idle": "Idle",
  "session.inspector.status.retry": "Retrying",
  "session.inspector.status.archived": "Archived",
  "session.inspector.status.unknown": "Unknown",
  "session.inspector.loadEarlier": "Load earlier activity",
  "session.inspector.loadingEarlier": "Loading earlier activity",
  "session.inspector.openFullTask": "Open full task",
  "session.inspector.output": "Output",
  "session.inspector.input": "Input",
  "session.inspector.error": "Error",
  "session.inspector.missingTool": "Tool details are unavailable",
  "session.inspector.missingSession": "This task is unavailable",
  "session.inspector.child.empty": "No messages yet",
  "session.inspector.loadFailed": "Activity could not be loaded",
  ...
  "prompt.toast.engineUnavailable.title": "Unable to determine the session engine",
  "prompt.toast.codexUnsupported.title": "This input is not supported by Codex",
  "prompt.toast.codexUnsupported.description":
    "Codex sessions do not support shell mode, OpenCode commands, or @agent mentions.",
  ...
  "codex.runtime.creating": "Creating",
  "codex.runtime.idle": "Ready",
  "codex.runtime.active": "Running",
  "codex.runtime.waitingApproval": "Waiting for approval",
  "codex.runtime.waitingInput": "Waiting for input",
  "codex.runtime.interrupting": "Stopping",
  "codex.runtime.disconnected": "Disconnected",
  "codex.runtime.systemError": "System error",
  "codex.runtime.bindingUnavailable": "Native session unavailable",
  "codex.account.signIn": "Sign in to Codex",
  "codex.account.cancelSignIn": "Cancel sign-in",
  "codex.account.pending": "Waiting for sign-in",
  "codex.account.signedIn": "Signed in to Codex",
  "codex.account.unavailable": "Codex is unavailable",
  ...
  "codex.settings.updateFailed": "Could not update Codex settings",
  "codex.settings.nativeDefault": "Native default",
  "codex.permission.workspace": "Workspace access",
  "codex.permission.nativeDefault": "Native default",
  "codex.permission.readOnly": "Read only",
  "codex.permission.full": "Full access",
  "codex.plan.title": "Latest reported plan",
  "codex.plan.loading": "Loading plan...",
  "codex.plan.pending": "Pending",
  "codex.plan.inProgress": "In progress",
  "codex.plan.completed": "Completed",
  "codex.queue.title": "Queue",
  "codex.queue.paused": "Paused",
  "codex.queue.resume": "Resume",
  "codex.queue.pause": "Pause",
  "codex.queue.withdraw": "Withdraw",
  "codex.delivery.queue": "Queued input",
  "codex.delivery.steer": "Immediate input",
  "codex.delivery.pending": "Pending",
  "codex.delivery.returned": "Not delivered",
  "codex.delivery.returnedHint": "The turn ended without this input entering the session. Resume to send it again.",
  "codex.delivery.pausedHint": "This input is paused. Resume to send it.",
  "codex.delivery.waitEarlier": "Waiting for an earlier input.",
  "codex.delivery.waitIdle": "Waiting for the current turn to finish.",
  "codex.delivery.waitSettings": "Waiting for the next turn to apply the selected settings.",
  "codex.delivery.sending": "Sending",
  "codex.delivery.accepted": "Accepted",
  "codex.delivery.unknown": "Status unknown",
  "codex.delivery.rejected": "Rejected",
  ...
  "codex.interaction.choice.allowSession": "Allow for this task",
  "codex.interaction.choice.deny": "Deny",
  "codex.interaction.choice.cancel": "Cancel",
  "codex.interaction.choice.custom": "Use custom response",
  "codex.interaction.choice.allowCommandRule": "Allow and remember command rule",
  "codex.interaction.choice.commandRuleHint": "Don't ask again for commands starting with: {{prefix}}",
  "codex.interaction.choice.allowNetworkRule": "Always allow access to {{host}}",
  "codex.interaction.choice.denyNetworkRule": "Block access to {{host}}",
  "codex.question.other": "Other response",
  "codex.question.placeholder": "Enter a response",
  "codex.form.invalid": "Codex requested a form this version cannot display.",
  "codex.url.open": "Open link",
  "codex.context.currentTokens": "Current context tokens",
  "codex.context.totalTokens": "Cumulative tokens",
  "codex.diff.unavailable": "Codex did not provide a diff for this turn.",
  ...
  "context.usage.contextWindow": "Context window",
  "context.usage.used": "used",
  "context.usage.tokenRange": "{{used}} / {{limit}} tokens",
  "context.usage.sessionCost": "Session cost (estimated)",
  "context.usage.limit": "Usage limit",
  "context.usage.resets": "Resets {{time}}",
  "context.usage.credits": "Credits remaining",
  "context.usage.unlimited": "Unlimited",
  ...
  "session.new.worktree.label": "Worktree",
  "session.new.worktree.baseBranch": "Base branch",
  "session.new.worktree.optionsFailed": "Could not load worktree options",
  "session.new.worktree.useLocal": "Use local folder",
  "prompt.toast.worktreeNotReady.title": "Choose where to run this task before sending",
  ...
  "settings.computerUse.title": "Computer control",
  "settings.computerUse.description": "Let the agent observe and operate apps on the task’s host device.",
  "settings.computerUse.enable": "Enable computer control",
  "settings.computerUse.scope":
    "Applies to OpenCode and Codex on this device. Changes take effect on the next turn; an operation already running may finish.",
  "settings.computerUse.device": "Controlled device",
  "settings.computerUse.loading": "Checking…",
  "settings.computerUse.unsupported": "Setup currently supports macOS",
  "settings.computerUse.busy": "Setting up…",
  "settings.computerUse.error": "Needs attention",
  "settings.computerUse.notInstalled": "Not installed",
  "settings.computerUse.notRunning": "Driver not running",
  "settings.computerUse.permissions": "Permissions needed",
  "settings.computerUse.ready": "Driver ready",
  "settings.computerUse.disabled": "Disabled",
  "settings.computerUse.installTitle": "1. Install and start CuaDriver",
  "settings.computerUse.installDescription":
    "CuaDriver observes the screen and operates apps. It starts after installation so you can grant permissions below.",
  "settings.computerUse.install": "Install and start CuaDriver",
  "settings.computerUse.installing": "Installing and starting…",
  "settings.computerUse.starting": "Starting…",
  "settings.computerUse.running": "Running",
  "settings.computerUse.start": "Start driver",
  "settings.computerUse.refresh": "Check permissions again",
  "settings.computerUse.permissionsTitle": "2. Grant system permissions",
  ...
  "settings.computerUse.readyToEnable": "Both permissions are granted. You can enable computer control.",
  "settings.computerUse.finishSetup": "Complete installation and grant both permissions to enable computer control.",
  "settings.section.desktop": "Desktop",
  "settings.section.server": "Server",
  "settings.connections.copy": "Copy",
  "settings.remote.rename": "Rename",
  "settings.tab.connections": "Connections",
  "settings.remote.cleanup.expiration":
    "Manual cleanup is available here. The service normally expires tunnels after 30 days without activity.",
  "settings.remote.cleanup.note":
    "Offline registrations still use quota. Cleanup removes only tunnel registrations; projects and tasks stay on the device.",
  "settings.remote.cleanup.refreshRequired": "Could not load current device status. Refresh before cleaning up.",
  "settings.remote.cleanup.empty": "No offline registrations to clean up.",
  "settings.remote.cleanup.failed": "Could not delete; refresh and retry",
  "settings.remote.cleanup.protected": "This registration is protected; kept",
  "settings.remote.cleanup.unknown": "Cannot confirm offline state; kept",
  "settings.remote.cleanup.online": "Now online; kept",
  "settings.remote.cleanup.result": "Cleaned up {{count}} registrations.",
  "settings.remote.cleanup.removing": "Deleting…",
  "settings.remote.cleanup.remove": "Delete {{count}} registrations",
  "settings.remote.cleanup.consequence":
    "Deleting invalidates the old tunnel link. Projects and tasks stay on the device. It can register again when remote access is enabled.",
  "settings.remote.cleanup.scope":
    "Only confirmed offline devices are listed. This device, active connections and unknown states are excluded.",
  "settings.remote.cleanup.selectAll": "Select / clear all",
  "settings.remote.cleanup.candidates": "{{count}} offline registrations",
  "settings.remote.cleanup.description":
    "Choose Koma registrations you no longer need. An offline device may just be asleep or temporarily shut down.",
  "settings.remote.cleanup.device": "Delete tunnel for {{name}}",
  "settings.remote.cleanup.title": "Clean up offline registrations",
  "settings.remote.quota.full": "Tunnel quota reached. Remove unused offline registrations before adding a device.",
  "settings.remote.quota.koma": "Koma registrations: {{count}}",
  "settings.remote.quota.title": "Account tunnel usage (all apps)",
  "settings.remote.devices.incomplete": "Incomplete registration · unavailable for connection",
  "settings.remote.website.description": "Sign in from another device’s browser and choose an online device.",
  "settings.remote.account.signOut.description":
    "Signing out closes this device’s tunnel and connections made through this account. Saved service addresses, local web access and cloud registrations are kept.",
  "settings.remote.local.disable.description":
    "Other devices will lose tunnel access to this device. Local tasks, outgoing connections and the tunnel registration are kept.",
  "settings.remote.local.disable": "Turn off this device’s tunnel",
  "settings.connections.native.note":
    "Tasks run on their own service. Opening another service does not stop existing tasks.",
  "settings.connections.web": "Local web access",
  "settings.connections.openProjects": "Open projects",
  "settings.connections.saved.description":
    "Add local, LAN or public service addresses. Multiple services can stay available.",
  "settings.connections.builtin": "Built-in",
  "settings.connections.localDevice": "This device",
  "settings.connections.local": "Local service",
  "settings.connections.tunnel": "Remote tunnels",
  "settings.connections.native": "Native services",
  "settings.connections.description": "Manage service addresses and access devices through remote tunnels.",
  "settings.connections.saved": "Service addresses",
  "settings.connections.devices": "Devices on your account",
  "settings.tab.general": "General",
  "settings.tab.shortcuts": "Shortcuts",
  "settings.tab.remote": "Remote",
  "settings.remote.title": "Remote",
  "settings.remote.description": "Continue working from another device, or connect to one of your other computers.",
  "settings.remote.loading": "Loading remote access...",
  "settings.remote.refresh": "Refresh",
  "settings.remote.account.title": "GitHub account",
  "settings.remote.account.description": "Sign in to discover your devices and enable remote access to this computer.",
  "settings.remote.account.signedIn": "Signed in with GitHub",
  "settings.remote.account.signIn": "Sign in",
  "settings.remote.account.signingIn": "Waiting for sign-in...",
  "settings.remote.account.signOut": "Sign out",
  "settings.remote.account.signingOut": "Signing out...",
  "settings.remote.authorization.title": "Finish signing in on GitHub",
  "settings.remote.authorization.description": "Copy this one-time code, then open GitHub to authorize access.",
  "settings.remote.authorization.code": "One-time code",
  "settings.remote.authorization.copy": "Copy code",
  "settings.remote.authorization.open": "Open GitHub",
  "settings.remote.authorization.cancel": "Cancel sign-in",
  "settings.remote.authorization.waiting": "Waiting for GitHub authorization...",
  "settings.remote.authorization.attribution":
    "GitHub may show Visual Studio Code on the authorization page. This experimental feature uses that sign-in client.",
  "settings.remote.local.section": "This computer",
  "settings.remote.local.enable.title": "Allow remote tunnel access to this device",
  "settings.remote.local.enable.description":
    "Share this device with your GitHub account. Connecting to other devices works independently.",
  "settings.remote.local.enable.signedOut": "Turning this on will guide you through GitHub sign-in.",
  "settings.remote.local.deviceName": "Device name",
  "settings.remote.local.deviceName.description":
    "Shown in the device list. Saving while sharing briefly reconnects the local tunnel.",
  "settings.remote.local.status": "Connection status",
  "settings.remote.local.website": "Remote web access",
  ...
  "settings.remote.status.online": "Ready for remote access",
  "settings.remote.status.offline": "Offline",
  "settings.remote.devices.section": "Other devices",
  "settings.remote.devices.signedOut": "Sign in to see other devices with remote access enabled.",
  "settings.remote.devices.empty": "No other devices are available.",
  "settings.remote.devices.online": "Online",
  "settings.remote.devices.offline": "Offline",
  "settings.remote.devices.unknown": "Status unavailable",
  "settings.remote.devices.connect": "Connect",
  "settings.remote.devices.connecting": "Connecting...",
  "settings.remote.unavailable.title": "Remote access is unavailable",
  "settings.remote.unavailable.description": "This build has not been configured for Microsoft remote access.",
  "settings.remote.error.action": "The remote access action could not be completed. Try again.",
  "settings.remote.error.configuration": "Remote access is not configured correctly for this build.",
  "settings.remote.error.authentication": "Your GitHub sign-in needs attention. Sign in again.",
  "settings.remote.error.connection": "Remote access cannot connect right now.",
  "settings.remote.service": "Connection service provided by Microsoft Dev Tunnels",
  ...
  "worktree.manager.title": "Worktree management",
  "worktree.manager.description": "Inspect linked directories, task ownership, and cleanup state.",
  "worktree.manager.refresh": "Refresh",
  "worktree.manager.loading": "Loading worktrees…",
  "worktree.manager.loadFailed": "Could not load worktrees.",
  "worktree.manager.retry": "Retry",
  "worktree.manager.empty": "No linked worktrees were found.",
  "worktree.manager.status.primary": "Primary",
  "worktree.manager.status.managed": "Managed",
  "worktree.manager.status.unbound": "Unbound",
  "worktree.manager.status.shared": "Shared",
  "worktree.manager.status.missing": "Missing",
  "worktree.manager.status.inUse": "In use",
  "worktree.manager.status.idle": "Idle",
  "worktree.manager.branch.detached": "Detached HEAD",
  "worktree.manager.sessions": "Related tasks",
  "worktree.manager.noSessions": "No related tasks",
  "worktree.manager.archived": "Archived",
  "worktree.manager.directoryStatus": "Directory status",
  "worktree.manager.ownerFailure": "Last lifecycle operation failed",
  "worktree.manager.space": "Disk usage",
  "worktree.manager.spacePending": "Calculating…",
  "worktree.manager.open": "Open directory",
  ...
  "worktree.manager.confirm": "Confirm",
  "worktree.manager.cancel": "Cancel",
  "worktree.manager.operationFailed": "The operation failed. You can retry without closing this dialog.",
  "worktree.manager.ignored.title": "Archive file retention",
  "worktree.manager.ignored.description":
    "Ordinary local files are preserved for managed archival; rebuildable dependencies and caches are skipped.",
  "worktree.manager.ignored.preserved": "Preserved",
  "worktree.manager.ignored.skipped": "Skipped",
  "worktree.manager.ignored.unsupported": "Unsupported",
  "worktree.manager.ignored.none": "None",
  "worktree.manager.usageBoundary":
    "Terminal usage is recorded by the backend from each terminal's starting directory. External processes, terminals that later change directory, and detached child processes are outside this check.",
  "worktree.merge.preview": "Preview merge",
  "worktree.merge.title": "Merge into primary directory",
  "worktree.merge.description":
    "Review the result before placing it in the primary directory's staging area. The primary directory must remain clean and unchanged.",
  "worktree.merge.target": "Target",
  "worktree.merge.files": "Changed files",
  "worktree.merge.conflicts": "Conflicts",
  "worktree.merge.noChanges": "No changed files to apply.",
  "worktree.merge.truncated": "The patch preview is truncated.",
  "worktree.merge.conflictHelp": "Open the source directory, resolve these conflicts, then preview again.",
  "worktree.merge.apply": "Apply to staging area",
  "worktree.merge.applied": "Changes are in the primary directory's staging area, ready for review and commit.",
  "worktree.merge.previewFailed": "Could not preview the merge.",
  "worktree.merge.applyFailed": "Could not apply the reviewed merge. Preview again before retrying.",
  "worktree.merge.retry": "Preview again",
  "worktree.merge.close": "Close preview",
  "worktree.manager.lifecycle.archive": "Archiving",
  "worktree.manager.lifecycle.restore": "Restoring",
  "worktree.manager.lifecycle.delete": "Deleting",
  "worktree.manager.lifecycle.reclaimed": "Reclaimed",
  "worktree.manager.lifecycle.preserved": "Local files preserved",
  "worktree.merge.conflictChoice":
    "Each choice takes the entire file from that side. Select every file, then preview the result again.",
  "worktree.merge.keepTarget": "Keep primary directory version",
  "worktree.merge.useSource": "Use Worktree version",
  "worktree.merge.previewSelections": "Preview selected versions",
  "worktree.merge.unresolved": "Select a version for every conflict before previewing again.",
  "worktree.merge.directoriesUnchanged":
    "Previewing, changing a selection, or cancelling does not modify either directory.",
  "worktree.merge.selectionChanged": "The selection changed. Preview the selected versions again before applying.",
}
