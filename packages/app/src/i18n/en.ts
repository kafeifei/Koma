...
export const dict = {
  ...
  "settings.remote.account.description": "Sign in to view and connect to your devices.",
  ...
  "settings.remote.local.enable.title": "Allow remote access",
  "settings.remote.local.enable.description": "Access this computer with the same GitHub account.",
