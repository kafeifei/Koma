...
export const dict = {
  ...
  "prompt.toast.engineUnavailable.title": "無法判斷工作階段引擎",
  "prompt.toast.codexUnsupported.title": "Codex 不支援此輸入",
  "prompt.toast.codexUnsupported.description": "Codex 工作階段不支援 shell 模式、OpenCode 命令或 @代理程式 提及。",
  ...
  "codex.runtime.creating": "正在建立",
  "codex.runtime.idle": "就緒",
  "codex.runtime.active": "執行中",
  "codex.runtime.waitingApproval": "等待核准",
  "codex.runtime.waitingInput": "等待輸入",
  "codex.runtime.interrupting": "正在停止",
  "codex.runtime.disconnected": "已中斷連線",
  "codex.runtime.systemError": "系統錯誤",
  "codex.runtime.bindingUnavailable": "原生工作階段無法使用",
  "codex.account.signIn": "登入 Codex",
  "codex.account.cancelSignIn": "取消登入",
  "codex.account.pending": "等待登入",
  "codex.account.signedIn": "已登入 Codex",
  "codex.account.unavailable": "Codex 無法使用",
  ...
  "codex.settings.updateFailed": "無法更新 Codex 設定",
  "codex.settings.nativeDefault": "原生預設值",
  "codex.permission.workspace": "工作區存取權",
  "codex.permission.nativeDefault": "原生預設值",
  "codex.permission.readOnly": "唯讀",
  "codex.permission.full": "完整存取權",
  "codex.plan.title": "最近回報的計畫",
  "codex.plan.loading": "正在載入計畫...",
  "codex.plan.pending": "待處理",
  "codex.plan.inProgress": "進行中",
  "codex.plan.completed": "已完成",
  "codex.queue.title": "佇列",
  "codex.queue.paused": "已暫停",
  "codex.queue.resume": "繼續",
  "codex.queue.pause": "暫停",
  "codex.queue.withdraw": "撤回",
  "codex.delivery.queue": "排入佇列的輸入",
  "codex.delivery.steer": "即時輸入",
  "codex.delivery.pending": "等待傳送",
  "codex.delivery.returned": "未進入工作階段",
  "codex.delivery.returnedHint": "該輪已結束，這則輸入未進入工作階段。繼續後可以重新傳送。",
  "codex.delivery.pausedHint": "這則輸入已暫停，繼續後才會傳送。",
  "codex.delivery.waitEarlier": "正在等待前一則輸入。",
  "codex.delivery.waitIdle": "正在等待目前輪次結束。",
  "codex.delivery.waitSettings": "正在等待下一輪套用所選設定。",
  "codex.delivery.sending": "正在傳送",
  "codex.delivery.accepted": "已接收",
  "codex.delivery.unknown": "狀態不明",
  "codex.delivery.rejected": "已拒絕",
  "codex.delivery.withdrawn": "已撤回",
  "codex.delivery.unknownHint": "不會自動重新傳送此輸入。",
  "codex.delivery.check": "檢查狀態",
  "codex.delivery.unconfirmedActiveHint": "等待確認這則輸入已進入工作階段。",
  "codex.delivery.unconfirmedHint": "尚未確認送達。原始輸入已儲存，不會自動重送。",
  "codex.delivery.copyText": "複製文字到輸入框",
  "codex.interaction.title": "Codex 需要你的輸入",
  "codex.interaction.reply": "回覆",
  "codex.interaction.choice.allow": "允許一次",
  "codex.interaction.choice.allowSession": "在此任務中允許",
  "codex.interaction.choice.deny": "拒絕",
  "codex.interaction.choice.cancel": "取消",
  "codex.interaction.choice.custom": "使用自訂回覆",
  "codex.question.other": "其他回覆",
  "codex.question.placeholder": "輸入回覆",
  "codex.form.invalid": "Codex 要求的表單無法在此版本中顯示。",
  "codex.url.open": "開啟連結",
  "codex.context.currentTokens": "目前上下文 token",
  "codex.context.totalTokens": "累計 token",
  "codex.diff.unavailable": "Codex 未提供這一輪的變更記錄。",
  ...
  "context.usage.contextWindow": "上下文視窗",
  "context.usage.used": "已用",
  "context.usage.tokenRange": "{{used}} / {{limit}} token",
  "context.usage.sessionCost": "對話費用（估算）",
  "context.usage.limit": "使用額度",
  "context.usage.resets": "{{time}} 重設",
  "context.usage.credits": "剩餘額度",
  "context.usage.unlimited": "無限",
  ...
  "settings.connections.copy": "複製",
  "settings.remote.rename": "重新命名",
  "settings.remote.account.description": "登入以尋找其他電腦，也可開啟本機遠端存取。",
  "settings.remote.account.signIn": "登入",
  "settings.remote.account.signOut": "登出",
  "settings.remote.account.title": "GitHub 帳號",
  "settings.remote.authorization.attribution": "授權由 GitHub 與 Microsoft Dev Tunnels 提供。",
  "settings.remote.authorization.cancel": "取消登入",
  "settings.remote.authorization.copy": "複製代碼",
  "settings.remote.authorization.description": "複製此一次性代碼，然後開啟 GitHub 授權頁面。",
  "settings.remote.authorization.open": "開啟 GitHub",
  "settings.remote.authorization.title": "在 GitHub 上完成登入",
  "settings.remote.authorization.waiting": "正在等待 GitHub 授權…",
  "settings.remote.devices.connect": "連線",
  "settings.remote.devices.connecting": "正在連線…",
  "settings.remote.devices.empty": "沒有可用的裝置。",
  "settings.remote.devices.offline": "離線",
  "settings.remote.devices.online": "線上",
  "settings.remote.devices.signedOut": "登入後，這裡會顯示帳號中的裝置。",
  "settings.remote.devices.unknown": "狀態不可用",
  "settings.remote.error.action": "無法完成遠端存取操作，請重試。",
  "settings.remote.error.authentication": "GitHub 登入狀態需要處理，請重新登入。",
  "settings.remote.error.configuration": "此版本的遠端存取設定不正確。",
  "settings.remote.error.connection": "遠端存取暫時無法連線。",
  "settings.remote.loading": "正在載入遠端存取…",
  "settings.remote.local.deviceName": "裝置名稱",
  "settings.remote.local.enable.signedOut": "開啟時將引導您登入 GitHub 帳號。",
  "settings.remote.refresh": "重新整理",
  "settings.remote.service": "連線服務由 Microsoft Dev Tunnels 提供",
  "settings.remote.status.connecting": "正在連線…",
  "settings.remote.status.disabled": "已關閉",
  "settings.remote.status.offline": "離線",
  "settings.remote.status.online": "已就緒，可遠端存取",
  "settings.remote.unavailable.description": "此版本尚未設定 Microsoft 遠端存取。",
  "settings.webEntry.description": "在本機瀏覽器中開啟桌面版的任務。",
  "settings.webEntry.error": "無法啟動本機網頁入口，請重試。",
  "settings.webEntry.title": "網頁入口",
  "settings.tab.connections": "連線",
  "settings.remote.cleanup.expiration": "本頁提供手動清理。服務商預設在連續 30 天無活動後回收隧道。",
  "settings.remote.cleanup.note": "離線記錄仍占名額。清理僅刪除隧道登記，裝置上的專案與任務保留。",
  "settings.remote.cleanup.refreshRequired": "暫時無法取得裝置狀態，請重新整理後再清理。",
  "settings.remote.cleanup.empty": "沒有可清理的離線記錄。",
  "settings.remote.cleanup.failed": "刪除失敗，請重新整理後重試",
  "settings.remote.cleanup.protected": "此記錄受保護，已保留",
  "settings.remote.cleanup.unknown": "無法確認離線狀態，已保留",
  "settings.remote.cleanup.online": "裝置已上線，已保留",
  "settings.remote.cleanup.result": "已清理 {{count}} 筆記錄。",
  "settings.remote.cleanup.removing": "正在刪除…",
  "settings.remote.cleanup.remove": "刪除 {{count}} 筆記錄",
  "settings.remote.cleanup.consequence":
    "刪除後原隧道入口失效，裝置上的專案與任務保留。再次開啟遠端存取時可以重新登記。",
  "settings.remote.cleanup.scope": "僅列出已確認離線的其他裝置。本機、已接入裝置和狀態未知的記錄不會被清理。",
  "settings.remote.cleanup.selectAll": "全選 / 取消全選",
  "settings.remote.cleanup.candidates": "{{count}} 筆可清理記錄",
  "settings.remote.cleanup.description": "選擇不再使用的 Koma 隧道。離線裝置也可能只是休眠或暫時關機。",
  "settings.remote.cleanup.device": "刪除 {{name}} 的隧道",
  "settings.remote.cleanup.title": "清理離線記錄",
  "settings.remote.quota.full": "隧道名額已滿。清理不再使用的離線記錄後，可繼續新增裝置。",
  "settings.remote.quota.koma": "Koma 登記 {{count}} 筆",
  "settings.remote.quota.title": "帳號隧道名額（含其他應用程式）",
  "settings.remote.devices.incomplete": "登記不完整 · 暫時無法連線",
  "settings.remote.website.description": "在其他裝置的瀏覽器登入，選擇要存取的線上裝置。",
  "settings.remote.local.website": "遠端 Web 入口",
  "settings.remote.account.signOut.description":
    "登出會關閉本機隧道，並中斷透過此帳號建立的裝置連線。已儲存的服務位址、本機 Web 入口和雲端登記會保留。",
  "settings.remote.local.deviceName.description": "顯示在裝置清單中。隧道開啟時，儲存名稱會短暫重建本機隧道連線。",
  "settings.remote.local.disable.description":
    "其他裝置將無法透過此隧道存取本機。本機任務、已連線的其他裝置及隧道登記會保留。",
  "settings.remote.local.disable": "關閉本機遠端隧道",
  "settings.remote.local.enable.description": "使用同一 GitHub 帳號存取本機，與連線其他裝置相互獨立。",
  "settings.remote.local.enable.title": "允許透過遠端隧道存取本機",
  "settings.connections.native.note": "任務在所屬服務上執行，開啟其他服務的專案不會停止既有任務。",
  "settings.connections.web": "本機 Web 入口",
  "settings.connections.openProjects": "開啟專案",
  "settings.connections.saved.description": "新增本機、區域網路或公開位址，可同時接入多個服務。",
  "settings.connections.builtin": "應用程式內建",
  "settings.connections.localDevice": "本機",
  "settings.connections.local": "本機服務",
  "settings.connections.tunnel": "遠端隧道",
  "settings.connections.native": "原生服務",
  "settings.connections.description": "管理服務位址，以及透過遠端隧道存取裝置的方式。",
  "settings.connections.saved": "服務位址",
  "settings.connections.devices": "帳號中的裝置",
