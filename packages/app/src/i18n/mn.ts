export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma цэс",
  ...
  "desktop.recovery.loadFailed": "Koma ачаалж чадсангүй",
  "desktop.recovery.terminated": "Koma цонх гэнэт хаагдсан",
  "desktop.recovery.unresponsive": "Koma хариу өгөхгүй байна",
  ...
  "help.tabs.introduction": "Koma Desktop одоо табуудыг тойрон бүтээгдсэн.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Koma ({{version}}) шинэ хувилбарыг одоо суулгах боломжтой.",
  ...
  "error.page.report.prefix": "Энэ алдааг Koma багт мэдэгдэнэ үү",
  ...
  "settings.general.row.language.description": "Koma дэлгэцийн хэлийг өөрчлөх",
  ...
  "settings.general.row.appearance.description": "Koma төхөөрөмж дээрээ хэрхэн харагдахыг тохируулна уу",
  "settings.general.row.colorScheme.title": "Өнгөний схем",
  "settings.general.row.colorScheme.description":
    "Koma нь систем, цайвар эсвэл бараан загварт тохирох эсэхийг сонгоно уу",
  "settings.general.row.theme.title": "Сэдэв",
  "settings.general.row.theme.description": "Koma-г хэрхэн загварчлахыг тохируулна уу.",
  ...
  "settings.updates.row.startup.description": "Koma эхлүүлэх үед шинэчлэлтүүдийг автоматаар шалгана уу",
  ...
  "settings.updates.toast.latest.description": "Та Koma-н хамгийн сүүлийн хувилбарыг ажиллуулж байна.",
