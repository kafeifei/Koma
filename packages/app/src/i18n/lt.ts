...
export const dict = {
  ...
  "help.tabs.introduction": "Koma Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Koma ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Koma komandai",
  ...
  "app.name.desktop": "Koma darbalaukis",
  ...
  "settings.general.row.language.description": "Pakeiskite Koma ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Koma atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Koma seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Koma temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Koma",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Koma versiją.",
