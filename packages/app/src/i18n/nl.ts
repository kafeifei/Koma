export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koma kan niet worden geladen",
  "desktop.recovery.terminated": "Het Koma-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Koma reageert niet",
  ...
  "help.tabs.introduction": "Koma Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Koma ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Koma-team",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Koma",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Koma eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Koma het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Koma aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Koma wordt gestart",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Koma.",
