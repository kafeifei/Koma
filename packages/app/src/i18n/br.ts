export const dict = {
  ...
  "desktop.menu.ariaLabel": "Menu do Koma",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Koma",
  "desktop.recovery.terminated": "A janela do Koma foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Koma não está respondendo",
  ...
  "help.tabs.introduction": "Agora, o Koma Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Koma ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Koma",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Koma",
  ...
  "settings.general.row.appearance.description": "Personalize como o Koma aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Koma segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Koma é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Koma iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Koma.",
