export const dict = {
  ...
  "desktop.menu.ariaLabel": "Nabídka Koma",
  ...
  "desktop.recovery.loadFailed": "Koma se nepodařilo načíst",
  "desktop.recovery.terminated": "Koma okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Koma nereaguje",
  ...
  "help.tabs.introduction": "Koma Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Koma ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Koma",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Koma",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Koma na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description": "Zvolte, zda bude Koma následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Koma.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Koma",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Koma.",
