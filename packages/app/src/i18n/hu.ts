...
export const dict = {
  ...
  "help.tabs.introduction": "A Koma Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Koma ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Koma csapatának",
  ...
  "app.name.desktop": "Koma asztali számítógép",
  ...
  "settings.general.row.language.description": "Módosítsa a Koma kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Koma az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Koma a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Koma témáját.",
  ...
  "settings.updates.row.startup.description": "A Koma indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Koma legújabb verzióját futtatja.",
