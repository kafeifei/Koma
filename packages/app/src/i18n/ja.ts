export const dict = {
  ...
  "desktop.menu.ariaLabel": "Komaメニュー",
  ...
  "desktop.recovery.loadFailed": "Komaを読み込めませんでした",
  "desktop.recovery.terminated": "Komaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Komaが応答していません",
  ...
  "help.tabs.introduction": "Koma Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Komaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをKomaチームに報告してください: ",
  ...
  "settings.general.row.language.description": "Komaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのKomaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Komaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Komaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Koma の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Koma は最新バージョンです。",
