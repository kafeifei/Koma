export const dict = {
  ...
  "desktop.recovery.loadFailed": "Koma kunde inte läsas in",
  "desktop.recovery.terminated": "Koma-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Koma svarar inte",
  ...
  "help.tabs.introduction": "Koma Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Koma ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Koma-teamet",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Koma",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Koma ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Koma följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Komas tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Koma startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Koma.",
