export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Koma",
  "desktop.recovery.terminated": "Okno Koma zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Koma nie odpowiada",
  ...
  "help.tabs.introduction": "Koma Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Koma ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Koma",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Koma",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Koma na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Koma ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Koma.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Koma",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Koma.",
