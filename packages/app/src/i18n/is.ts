...
export const dict = {
  ...
  "help.tabs.introduction": "Koma Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Koma ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Koma teymisins",
  ...
  "app.name.desktop": "Koma skjáborð",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Koma",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Koma lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Koma fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Koma er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Koma ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Koma.",
