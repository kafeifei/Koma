export const dict = {
  ...
  "desktop.menu.ariaLabel": "Koma menýusy",
  ...
  "desktop.recovery.loadFailed": "Koma ýükläp bilmedi",
  "desktop.recovery.terminated": "Koma penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Koma jogap berenok",
  ...
  "help.tabs.introduction": "Koma Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Koma ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Koma toparyna habar bermegiňizi haýyş edýäris",
  ...
  "settings.general.row.language.description": "Koma üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Koma enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description": "Koma ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Koma-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Koma işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Koma-iň iň soňky wersiýasyny işleýärsiňiz.",
