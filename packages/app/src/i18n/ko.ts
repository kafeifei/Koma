export const dict = {
  ...
  "toast.update.description": "Koma의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Koma 팀에 제보해 주세요: ",
  ...
  "settings.general.row.language.description": "Koma 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Koma가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Koma가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Koma 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Koma를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Koma를 사용 중입니다.",
  ...
  "help.tabs.introduction": "이제 Koma Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.menu.ariaLabel": "Koma 메뉴",
  ...
  "desktop.recovery.loadFailed": "Koma를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Koma 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Koma가 응답하지 않습니다",
