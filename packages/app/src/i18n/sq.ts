export const dict = {
  ...
  "desktop.menu.ariaLabel": "Menuja Koma",
  ...
  "desktop.recovery.loadFailed": "Koma nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Koma u mbyll papritur",
  "desktop.recovery.unresponsive": "Koma nuk po përgjigjet",
  ...
  "help.tabs.introduction": "Koma Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Koma ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Koma",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Koma",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Koma në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description": "Zgjidhni nëse Koma ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Koma.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Koma",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Koma.",
