import type {
  ...
  SessionsSetPermissionModeInput,
  SessionsSetPermissionModeOutput,
  SessionsPromptInput,
...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    sessions: {
      ...
      setPermissionMode: (input: SessionsSetPermissionModeInput, requestOptions?: RequestOptions) =>
        request<SessionsSetPermissionModeOutput>(
          {
            method: "POST",
