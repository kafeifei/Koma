...
type Endpoint1_0Request = Parameters<RawClient["server.directory"]["directory.list"]>[0]
type Endpoint1_0Input = { readonly path: Endpoint1_0Request["query"]["path"] }
const Endpoint1_0 = (raw: RawClient["server.directory"]) => (input: Endpoint1_0Input) =>
  raw["directory.list"]({ query: { path: input["path"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup1 = (raw: RawClient["server.directory"]) => ({ list: Endpoint1_0(raw) })
...
const Endpoint4_0 = (raw: RawClient["server.session"]) => () =>
  raw["session.capabilities"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_1Request = Parameters<RawClient["server.session"]["session.archive"]>[0]
...
type Endpoint4_2Request = Parameters<RawClient["server.session"]["session.restore"]>[0]
type Endpoint4_2Input = { readonly sessionID: Endpoint4_2Request["params"]["sessionID"] }
const Endpoint4_2 = (raw: RawClient["server.session"]) => (input: Endpoint4_2Input) =>
  raw["session.restore"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint4_3Request = Parameters<RawClient["server.session"]["session.remove"]>[0]
...
type Endpoint4_4Request = Parameters<RawClient["server.session"]["session.list"]>[0]
type Endpoint4_4Input = {
  readonly workspace?: Endpoint4_4Request["query"]["workspace"]
  readonly limit?: Endpoint4_4Request["query"]["limit"]
  readonly order?: Endpoint4_4Request["query"]["order"]
  readonly search?: Endpoint4_4Request["query"]["search"]
  readonly directory?: Endpoint4_4Request["query"]["directory"]
  readonly project?: Endpoint4_4Request["query"]["project"]
  readonly subpath?: Endpoint4_4Request["query"]["subpath"]
  readonly cursor?: Endpoint4_4Request["query"]["cursor"]
}
...
type Endpoint4_5Request = Parameters<RawClient["server.session"]["session.create"]>[0]
type Endpoint4_5Input = {
  readonly id?: Endpoint4_5Request["payload"]["id"]
  readonly agent?: Endpoint4_5Request["payload"]["agent"]
  readonly model?: Endpoint4_5Request["payload"]["model"]
  readonly location?: Endpoint4_5Request["payload"]["location"]
  readonly permissionMode?: Endpoint4_5Request["payload"]["permissionMode"]
}
...
const Endpoint4_6 = (raw: RawClient["server.session"]) => () =>
  raw["session.active"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint4_7Request = Parameters<RawClient["server.session"]["session.get"]>[0]
...
type Endpoint4_8Request = Parameters<RawClient["server.session"]["session.switchAgent"]>[0]
type Endpoint4_8Input = {
  readonly sessionID: Endpoint4_8Request["params"]["sessionID"]
  readonly agent: Endpoint4_8Request["payload"]["agent"]
}
...
type Endpoint4_9Request = Parameters<RawClient["server.session"]["session.switchModel"]>[0]
...
const adaptGroup4 = (raw: RawClient["server.session"]) => ({
  capabilities: Endpoint4_0(raw),
  archive: Endpoint4_1(raw),
  restore: Endpoint4_2(raw),
  remove: Endpoint4_3(raw),
  list: Endpoint4_4(raw),
  create: Endpoint4_5(raw),
  active: Endpoint4_6(raw),
  get: Endpoint4_7(raw),
  switchAgent: Endpoint4_8(raw),
  switchModel: Endpoint4_9(raw),
  setPermissionMode: Endpoint4_10(raw),
  prompt: Endpoint4_11(raw),
...
const Endpoint19_0 = (raw: RawClient["server.lab"]) => () =>
  raw["lab.engines"]({}).pipe(Effect.mapError(mapClientError))

const Endpoint19_1 = (raw: RawClient["server.lab"]) => () =>
  raw["lab.account"]({}).pipe(Effect.mapError(mapClientError))

const Endpoint19_2 = (raw: RawClient["server.lab"]) => () => raw["lab.login"]({}).pipe(Effect.mapError(mapClientError))

type Endpoint19_3Request = Parameters<RawClient["server.lab"]["lab.cancelLogin"]>[0]
type Endpoint19_3Input = { readonly loginID: Endpoint19_3Request["payload"]["loginID"] }
const Endpoint19_3 = (raw: RawClient["server.lab"]) => (input: Endpoint19_3Input) =>
  raw["lab.cancelLogin"]({ payload: { loginID: input["loginID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint19_4Request = Parameters<RawClient["server.lab"]["lab.describe"]>[0]
type Endpoint19_4Input = { readonly sessionIDs: Endpoint19_4Request["payload"]["sessionIDs"] }
const Endpoint19_4 = (raw: RawClient["server.lab"]) => (input: Endpoint19_4Input) =>
  raw["lab.describe"]({ payload: { sessionIDs: input["sessionIDs"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint19_5Request = Parameters<RawClient["server.lab"]["lab.create"]>[0]
type Endpoint19_5Input = {
  readonly requestID: Endpoint19_5Request["payload"]["requestID"]
  readonly engine: Endpoint19_5Request["payload"]["engine"]
  readonly location: Endpoint19_5Request["payload"]["location"]
  readonly input: Endpoint19_5Request["payload"]["input"]
  readonly delivery: Endpoint19_5Request["payload"]["delivery"]
}
const Endpoint19_5 = (raw: RawClient["server.lab"]) => (input: Endpoint19_5Input) =>
  raw["lab.create"]({
    payload: {
...
type Endpoint19_6Request = Parameters<RawClient["server.lab"]["lab.snapshot"]>[0]
type Endpoint19_6Input = { readonly sessionID: Endpoint19_6Request["params"]["sessionID"] }
const Endpoint19_6 = (raw: RawClient["server.lab"]) => (input: Endpoint19_6Input) =>
  raw["lab.snapshot"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint19_7Request = Parameters<RawClient["server.lab"]["lab.submit"]>[0]
type Endpoint19_7Input = {
  readonly sessionID: Endpoint19_7Request["params"]["sessionID"]
  readonly requestID: Endpoint19_7Request["payload"]["requestID"]
  readonly input: Endpoint19_7Request["payload"]["input"]
  readonly delivery: Endpoint19_7Request["payload"]["delivery"]
}
const Endpoint19_7 = (raw: RawClient["server.lab"]) => (input: Endpoint19_7Input) =>
  raw["lab.submit"]({
    params: { sessionID: input["sessionID"] },
    payload: { requestID: input["requestID"], input: input["input"], delivery: input["delivery"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint19_8Request = Parameters<RawClient["server.lab"]["lab.delivery"]>[0]
type Endpoint19_8Input = {
  readonly sessionID: Endpoint19_8Request["params"]["sessionID"]
  readonly requestID: Endpoint19_8Request["params"]["requestID"]
}
const Endpoint19_8 = (raw: RawClient["server.lab"]) => (input: Endpoint19_8Input) =>
  raw["lab.delivery"]({ params: { sessionID: input["sessionID"], requestID: input["requestID"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint19_9Request = Parameters<RawClient["server.lab"]["lab.queue"]>[0]
type Endpoint19_9Input = {
  readonly sessionID: Endpoint19_9Request["params"]["sessionID"]
  readonly action: Endpoint19_9Request["payload"]["action"]
  readonly requestID: Endpoint19_9Request["payload"]["requestID"]
  readonly revision: Endpoint19_9Request["payload"]["revision"]
}
const Endpoint19_9 = (raw: RawClient["server.lab"]) => (input: Endpoint19_9Input) =>
  raw["lab.queue"]({
    params: { sessionID: input["sessionID"] },
...
const adaptGroup19 = (raw: RawClient["server.lab"]) => ({
  engines: Endpoint19_0(raw),
  account: Endpoint19_1(raw),
  login: Endpoint19_2(raw),
  cancelLogin: Endpoint19_3(raw),
  describe: Endpoint19_4(raw),
  create: Endpoint19_5(raw),
  snapshot: Endpoint19_6(raw),
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.directory": adaptGroup1(raw["server.directory"]),
  ...
  lab: adaptGroup19(raw["server.lab"]),
})
