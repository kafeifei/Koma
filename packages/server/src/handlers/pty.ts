...
import { ConflictError, ForbiddenError, PtyNotFoundError } from "@opencode-ai/protocol/errors"
import {
        ...
        Effect.fn(function* (ctx) {
          ...
          return yield* response(
            pty
              ...
              .pipe(
                Effect.catchTag(
                  "DirectoryLease.UnavailableError",
                  (error) => new ConflictError({ message: error.message, resource: error.directory }),
                ),
              ),
          )
        }),
