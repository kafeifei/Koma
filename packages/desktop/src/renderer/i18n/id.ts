export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Koma versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
