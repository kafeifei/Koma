export const dict = {
  ...
  "desktop.updater.none.message": "Már az Koma legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Koma {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
