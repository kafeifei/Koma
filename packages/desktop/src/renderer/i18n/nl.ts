export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Koma is gedownload. Wil je deze installeren en Koma opnieuw starten?",
