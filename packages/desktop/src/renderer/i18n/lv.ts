export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Koma versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Koma versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
