export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Koma a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
