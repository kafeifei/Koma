export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Koma er blevet downloadet. Vil du installere den og genstarte?",
