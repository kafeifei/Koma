export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Koma a fost descărcată. Vrei să o instalezi și să repornești?",
