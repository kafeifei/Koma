export const dict = {
  ...
  "desktop.updater.none.message": "Koma'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Koma'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
