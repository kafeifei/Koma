export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Koma. ¿Quieres instalarla y reiniciar?",
