export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Koma wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
