export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace Koma. Chcete ji nainstalovat a aplikaci znovu spustit?",
