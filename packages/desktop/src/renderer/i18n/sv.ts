export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Koma har laddats ned. Vill du installera den och starta om programmet?",
