export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Koma er lastet ned. Vil du installere den og starte på nytt?",
