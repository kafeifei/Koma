export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Koma. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
