export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Koma telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
