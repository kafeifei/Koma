export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Koma",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Koma è stata scaricata. Vuoi installarla e riavviare l'app?",
