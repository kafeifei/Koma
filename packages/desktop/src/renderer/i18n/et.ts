export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Koma uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Koma'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
