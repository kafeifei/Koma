export const dict = {
  ...
  "desktop.updater.none.message": "Používate najnovšiu verziu Koma",
  ...
  "desktop.updater.downloaded.prompt": "Verzia {{version}} Koma bola stiahnutá. Chcete ju nainštalovať a reštartovať?",
